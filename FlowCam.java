...
public class FlowCam {
   ...
   */
   ...
   /**
      ...
      two reasons.  One is that the Calibration may need to be set and Two is
      there may be no need for raw of cal images.
   ...
   */
   public void populate_file_lists(){
   ...
   */
   public String[] matchFiles(File dir, String what){
      ...
      if (what.equalsIgnoreCase("calImages")){
         ...
         //these are easier to lift from the data file
